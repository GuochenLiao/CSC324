...
salary_data <- read_csv("SweSalaries.csv", skip = 1, col_names = c("Index", "Metro", "MeanSalaryAdjusted", "MeanSalaryUnadjusted", "MeanSalary", "NumberJobs", "HomePrice", "City", "LivingCost", "Rent", "PlusRent", "PurPower"))
