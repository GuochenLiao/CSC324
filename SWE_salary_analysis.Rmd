...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      numericInput("minSalaryAdjusted", "Min Mean Salary Adjusted:", min = 0, max = max(us_states$MeanSalaryAdjusted, na.rm = TRUE), value = 0),
      numericInput("maxSalaryAdjusted", "Max Mean Salary Adjusted:", min = 0, max = max(us_states$MeanSalaryAdjusted, na.rm = TRUE), value = max(us_states$MeanSalaryAdjusted, na.rm = TRUE)),
      numericInput("minRent", "Min Rent:", min = 0, max = max(us_states$Rent, na.rm = TRUE), value = 0),
      numericInput("maxRent", "Max Rent:", min = 0, max = max(us_states$Rent, na.rm = TRUE), value = max(us_states$Rent, na.rm = TRUE)),
